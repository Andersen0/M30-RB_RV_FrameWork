...
static bool s0_gen(void) {
  return ((!((classifier_cpy) == ((int64_t)(1)))) || (((distance_to_target_cpy) > ((int64_t)(21))) == ((state_cpy) == ((int64_t)(0))))) && ((s0_get)((0)));
}

static bool s1_gen(void) {
  return ((distance_to_target_cpy) >= ((int64_t)(0))) && ((s1_get)((0)));
}

static bool s2_gen(void) {
  return ((!((classifier_cpy) == ((int64_t)(2)))) || (((distance_to_target_cpy) > ((int64_t)(21))) == ((state_cpy) == ((int64_t)(0))))) && ((s2_get)((0)));
}

static bool s3_gen(void) {
  return ((!((classifier_cpy) == ((int64_t)(2)))) || (((!((distance_to_target_cpy) > ((int64_t)(21)))) && ((distance_to_target_cpy) > ((int64_t)(14)))) == ((state_cpy) == ((int64_t)(2))))) && ((s3_get)((0)));
}

static bool s4_gen(void) {
  return ((!((classifier_cpy) == ((int64_t)(2)))) || ((!((distance_to_target_cpy) > ((int64_t)(14)))) == ((state_cpy) == ((int64_t)(3))))) && ((s4_get)((0)));
}

static bool s5_gen(void) {
  return ((!((classifier_cpy) == ((int64_t)(1)))) || (((!((distance_to_target_cpy) > ((int64_t)(21)))) && ((distance_to_target_cpy) > ((int64_t)(14)))) == ((state_cpy) == ((int64_t)(1))))) && ((s5_get)((0)));
}

static bool s6_gen(void) {
  return ((!((classifier_cpy) == ((int64_t)(1)))) || (((!((distance_to_target_cpy) > ((int64_t)(14)))) && ((distance_to_target_cpy) > ((int64_t)(7)))) == ((state_cpy) == ((int64_t)(2))))) && ((s6_get)((0)));
}

static bool s7_gen(void) {
  return ((!((classifier_cpy) == ((int64_t)(0)))) || ((((!(slowdown_cpy)) && (!(halt_cpy))) && (!(alert_cpy))) && (!(turnoffUVC_cpy)))) && ((s7_get)((0)));
}

static bool s8_gen(void) {
  return ((!((state_cpy) == ((int64_t)(3)))) || ((((!(slowdown_cpy)) && (halt_cpy)) && (alert_cpy)) && (turnoffUVC_cpy))) && ((s8_get)((0)));
}

static bool s9_gen(void) {
  return ((!((state_cpy) == ((int64_t)(0)))) || ((((!(slowdown_cpy)) && (!(halt_cpy))) && (!(alert_cpy))) && (!(turnoffUVC_cpy)))) && ((s9_get)((0)));
}

static bool s10_gen(void) {
  return ((!((state_cpy) == ((int64_t)(1)))) || ((((slowdown_cpy) && (!(halt_cpy))) && (alert_cpy)) && (!(turnoffUVC_cpy)))) && ((s10_get)((0)));
}

static bool s11_gen(void) {
  return (((!(((!((classifier_cpy) == ((int64_t)(0)))) && ((classifier_cpy) == ((int64_t)(1)))) || (((classifier_cpy) == ((int64_t)(0))) && (!((classifier_cpy) == ((int64_t)(1))))))) && ((classifier_cpy) == ((int64_t)(2)))) || ((((!((classifier_cpy) == ((int64_t)(0)))) && ((classifier_cpy) == ((int64_t)(1)))) || (((classifier_cpy) == ((int64_t)(0))) && (!((classifier_cpy) == ((int64_t)(1)))))) && (!((classifier_cpy) == ((int64_t)(2)))))) && ((s11_get)((0)));
}

static bool s12_gen(void) {
  return ((!((classifier_cpy) == ((int64_t)(1)))) || ((!((distance_to_target_cpy) > ((int64_t)(7)))) == ((state_cpy) == ((int64_t)(3))))) && ((s12_get)((0)));
}

static bool s13_gen(void) {
  return ((!((state_cpy) == ((int64_t)(2)))) || ((((!(slowdown_cpy)) && (halt_cpy)) && (alert_cpy)) && (!(turnoffUVC_cpy)))) && ((s13_get)((0)));
}
...
static bool handlerstate_req104_guard(void) {
  return !(((!((classifier_cpy) == ((int64_t)(1)))) || ((!((distance_to_target_cpy) > ((int64_t)(7)))) == ((state_cpy) == ((int64_t)(3))))) && ((s12_get)((0))));
}
