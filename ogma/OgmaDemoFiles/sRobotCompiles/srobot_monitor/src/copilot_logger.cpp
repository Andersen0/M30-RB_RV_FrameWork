...
class CopilotLogger : public rclcpp::Node {
  public:
    CopilotLogger() : Node("copilotlogger") {
      ...
      handlerstate_req104_subscription_ = this->create_subscription<std_msgs::msg::Empty>(
        "copilot/handlerstate_req104", 10,
        std::bind(&CopilotLogger::handlerstate_req104_callback, this, _1));
  ...
  private:
    ...
    void handlerstate_req104_callback(const std_msgs::msg::Empty::SharedPtr msg) const {
      RCLCPP_INFO(this->get_logger(), "Copilot monitor violation: handlerstate_req104");
    }
    ...
    rclcpp::Subscription<std_msgs::msg::Empty>::SharedPtr handlerstate_req104_subscription_;
